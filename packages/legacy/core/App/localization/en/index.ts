...
const translation = {
  ...
  "HowDoIAddMyIDs": {
    "Title": "How Do I Add My IDs?",
    "Preamble": "You can seamlessly add various IDs such as your national ID, passport, employee ID, student card, and alumni credentials. To do so:\n\n Use the dedicated button to upload chipped versions of your passport or T.R. ID. \n\n After adding your student or alumni account from e-Government, scan the QR code located at the bottom right of your graduation certificate using the \"Add via QR\" button. This allows you to easily integrate your student or graduate certificate into Fibon. \n\n As you add your IDs, you'll unlock special privileges. Access and view these privileges using the \"Credentials\" button. \n\nRemember, all your IDs are securely stored on your mobile phone. Your data is never shared with any institution without your explicit consent.\n\n\n\n\n",
  },
  "WhatIsFibon": {
    "Title": "What is Fibon?",
    "Preamble": "Fibon safeguards your identities (whether as a student or organization) across various institutions and organizations. This includes employee IDs, club membership IDs, etc. Utilizing blockchain technology, Fibon allows you to authenticate your identity to organizations. It's an enhanced digital identity management application.\n\n Which institution do you work for, or at which university are you enrolled? \n\n Instead of sending documents digitally via other means, with Fibon, you can request validation, store it in the app, and transmit it digitally wherever necessary.This ensures you can readily and securely avail benefits and opportunities provided by various institutions and organizations. \n\n Fibon ensures individual data privacy through blockchain technology, allowing users to manage their identities autonomously.The platform employs cryptographic methods that don't store personal data and uses digitally generated keys. Importantly, Fibon doesn't monitor your identity- related activities.\n\n\n\n\n",
  },
  "HelpAndSupport": {
    "Q1": "How do I log in to Fibon?",
    "A1": "After installing Fibon on your phone, tap the \"Quick Login\" button to access. In the \"Application Settings,\" if you enable the Biometric Login feature, you'll have the option for \"Hi Login\" and \"Biometric Login\" during future logins. Choose your preferred method. For biometric login, the app uses the pre-set Touch ID or Face ID on your phone.\n\n",
    "Q2": "Where do I get my digital ID?",
    "A2": "Upon your first login, only your mobile ID will be present in Fibon. However, you can add other IDs, like your national ID or passport, under the \"Credentials\" section. If affiliated brands or institutions are part of the Fibon ecosystem, you can acquire and integrate your digital identities from their secure platforms into Fibon.\n\n",
    "Q3": "What data is transferred to Fibon with my ID?",
    "A3": "All data from the institutions where you've acquired your IDs can be sent to Fibon. For instance, details on your student ID (student number, school name, graduation date, etc.) can be digitized. While Fibon presents your digital identities, it neither shares nor centrally stores your data.\n\n",
    "Q4": "Can I register any ID with Fibon?",
    "A4": "As long as the issuing institution provides a digital version of any ID, you can store it in Fibon. This includes national IDs, student or graduate certificates, and e-Government documents. To add a student document to Fibon, your student status should be active.\n\n",
    "Q5": "Where are my IDs stored?",
    "A5": "The identities you add to Fibon are stored solely within the app on your mobile device. No personal data is acquired or stored in any external data center. Fibon shares identity verification data only with institutions upon your consent. Developed with blockchain technology, Fibon ensures none of your data is shared without your explicit approval.\n\n",
    "Q6": "Where can I use my digital ID?",
    "A6": "You can use your digital identities for transactions within the Fibon ecosystem. For example, if an e-commerce site offers a special employee discount, you can prove your eligibility using your employee ID from Fibon. After adding your IDs, the \"Special for Me\" section provides details on their utility.\n\n",
    "Q7": "How do I authenticate my digital identity?",
    "A7": "Institutions requiring digital identity proof will have a \"Prove Your Identity with Fibon\" button. Clicking this presents a QR code. Scanning this code in Fibon's \"QR Reader\" section begins the verification process. You'll be asked which identity proof to use and, upon approval, your identity is confirmed to the institution.\n\n",
    "Q8": "Can I verify my identity from my mobile phone?",
    "A8": "Using Fibon, you can verify digital identities by scanning QR codes or following prompts on mobile screens, eliminating the need for multiple screens.\n\n",
    "Q9": "Can I modify or delete my credentials?",
    "A9": "You can view or delete your IDs in Fibon from the ID detail screen. Certain identity data cannot be deleted. Uninstalling the app deletes all stored identities. To remove your Fibon account, navigate to the \"Settings\" menu.\n\n\n\n\n",
  },
  "HowToUseFibon": {
    "Title": "How to Use Fibon?",
    "Preamble": "Recommended login methods include:\n\n",
    "A1":"Logging in with a trusted contact.",
    "A2":" After accepting the terms of use, you can scan the QR code at the desired institution or organization.",
    "A3":"Add your identities to Fibon.",
    "A4":"Share your identity verification with institutions or organizations upon their request and your consent.",
    "A5":"From the \"Credentials\" menu, you can view all your IDs, and by verifying your identities, you can see the various benefits and opportunities available to you.\n\n\n\n\n"
  },
  "Credentials": {
  ...
  "Settings": {
    ...
    "HowToUseFibon": "How to Use Fibon",
